  ...
  <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td>C'est l'occasion de vous engager a votre tour pour ces jeunes en confirmant leur richesse pour en avoir été un temps les témoins mais aussi les bénéficiaires!</td>
            </tr>
        </table>
        <h5 id="sous-titre2">Cet engagement est une ressource à valoriser au fil d'un parcours en 3 étapes:</h5>
        <div class="categorie">
                    <div class="titrecategorie1">
                        <p>ETAPE 1</p>
                        <p>la valorisation</p>
